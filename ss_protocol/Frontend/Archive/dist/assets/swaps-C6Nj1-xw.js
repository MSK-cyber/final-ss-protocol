import{h as A,ag as r,m as g,o as P,q as D,A as E,N as h,x as c,J as K,E as W,t as S,G as L,D as M,aU as F,z as Q,W as q,k as z,l as H,bl as j}from"./index-Fje8cVxI.js";import{S as n}from"./SwapController-CkLYJnme.js";import"./index-D0RKnu4E.js";const G={numericInputKeyDown(u,e,t){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=u.metaKey||u.ctrlKey,o=u.key,a=o.toLocaleLowerCase(),l=a==="a",b=a==="c",I=a==="v",_=a==="x",U=o===",",O=o===".",B=o>="0"&&o<="9";!s&&(l||b||I||_)&&u.preventDefault(),e==="0"&&!U&&!O&&o==="0"&&u.preventDefault(),e==="0"&&B&&(t(o),u.preventDefault()),(U||O)&&(e||(t("0."),u.preventDefault()),(e!=null&&e.includes(".")||e!=null&&e.includes(","))&&u.preventDefault()),!B&&!i.includes(o)&&!O&&!U&&u.preventDefault()}},J=A`
  :host {
    width: 100%;
  }
...
`;var V=function(u,e,t,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(u,e,t,i);else for(var l=u.length-1;l>=0;l--)(a=u[l])&&(o=(s<3?a(o):s>3?a(e,t,o):a(e,t))||o);return s>3&&o&&Object.defineProperty(e,t,o),o};let R=class extends D{constructor(){super(...arguments),this.target="sourceToken"}render(){return c`
    ...
    `}};R.styles=[Y];V([g()],R.prototype,"target",void 0);R=V([P("w3m-swap-input-skeleton")],R);const Z=A`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var T=function(u,e,t,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(u,e,t,i);else for(var l=u.length-1;l>=0;l--)(a=u[l])&&(o=(s<3?a(o):s>3?a(e,t,o):a(e,t))||o);return s>3&&o&&Object.defineProperty(e,t,o),o};const ee=5e-5;let m=class extends D{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return c`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){W.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),S.push("SwapSelectToken",{target:this.target})}onBuyToken(){S.push("OnRampProviders")}};m.styles=[Z];T([g()],m.prototype,"focused",void 0);T([g()],m.prototype,"balance",void 0);T([g()],m.prototype,"value",void 0);T([g()],m.prototype,"price",void 0);T([g()],m.prototype,"marketValue",void 0);T([g()],m.prototype,"disabled",void 0);T([g()],m.prototype,"target",void 0);T([g()],m.prototype,"token",void 0);T([g()],m.prototype,"onSetAmount",void 0);T([g()],m.prototype,"onSetMaxValue",void 0);m=T([P("w3m-swap-input")],m);const te=A`
